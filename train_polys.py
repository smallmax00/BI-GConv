...
snapshot_path = "../model/" + args.exp + "_{}_bs_beta_{}_base_lr{}".format(args.batch_size, args.beta, args.base_lr)
...
if __name__ == "__main__":
    ...
    db_train = polyp(base_dir=train_data_path,
                    split='train')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            volume_batch, label_batch, edge_batch_com = volume_batch.float().cuda(), label_batch.float().cuda(), edge_batch.float().cuda()
            ...
            region_loss = dice_loss(outputs.squeeze(), label_batch.squeeze().float())
            ...
            writer.add_scalar('loss/region_loss', region_loss, iter_num)
            writer.add_scalar('loss/edge_loss', edge_loss, iter_num)


            logging.info(
                'iteration %d : loss : %f, region_loss: %f, edge_loss: %f' %
                (iter_num, loss.item(), region_loss.item(), edge_loss.item()))
